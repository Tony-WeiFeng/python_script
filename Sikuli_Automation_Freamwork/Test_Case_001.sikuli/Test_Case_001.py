...
#Creat log file
ls = os.linesep
entry = getCurrentTime() + "  ==================Test_Case_001 Log Started==================\n"
...
doubleClick("1378465617482.png")
#click(Pattern("lIsInstaller.png").targetOffset(-29,1))
...
click(Pattern("DSampleApp.png").targetOffset(294,0))
    
fobj = open('C:\Users\Administrator\Desktop\log.txt','a')
fobj.writelines(getCurrentTime() + "  ==================Test_Case_001 Complete==================\n")
fobj.close()
